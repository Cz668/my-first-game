...
/* 12 */
/*!****************************************************************************************************!*\
  !*** C:/Users/Admin/Desktop/黑马优购/final-version-crow-game/main.js?{"page":"pages%2Findex%2Findex"} ***!
  \****************************************************************************************************/
...
/* 13 */
/*!*********************************************************************************!*\
  !*** C:/Users/Admin/Desktop/黑马优购/final-version-crow-game/pages/index/index.vue ***!
  \*********************************************************************************/
/*! no static exports found */
...
/* 14 */
/*!****************************************************************************************************************!*\
  !*** C:/Users/Admin/Desktop/黑马优购/final-version-crow-game/pages/index/index.vue?vue&type=template&id=57280228& ***!
  \****************************************************************************************************************/
...
/* 16 */
/*!**********************************************************************************************************!*\
  !*** C:/Users/Admin/Desktop/黑马优购/final-version-crow-game/pages/index/index.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 17 */
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--12-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!C:/Users/Admin/Desktop/黑马优购/final-version-crow-game/pages/index/index.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//         })
var Raven = /*#__PURE__*/function () {
  function Raven() {_classCallCheck(this, Raven);
    this.spritWidth = 271;
    ...
    this.color = "rgb(".concat(this.randomColor[0], ",").concat(this.randomColor[1], ",").concat(this.randomColor[2], ")"); //用于碰撞检验
    this.hasTrail = Math.random() > 0.5;
  }_createClass(Raven, [{ key: "update", value: function update(
    deltatime) {
      ...
      if (this.timeSinceFlap > this.flapInterval) {
        if (this.frame > this.maxFrame) this.frame = 0;else
        this.frame++;
        this.timeSinceFlap = 0;
        if (this.hasTrail) {
          for (var i = 0; i < 5; i++) {//限制粒子效果只出现5个
...
var Particle = /*#__PURE__*/function () {
  function Particle(x, y, size, color) {_classCallCheck(this, Particle);
    this.size = size;
...
Explosion = /*#__PURE__*/function () {
  function Explosion(x, y, size) {_classCallCheck(this, Explosion);
    this.image = canvas.createImage();
    ...
    this.markForDeletion = false;}_createClass(Explosion, [{ key: "update", value: function update(
    deltatime) {
...

{
  ...
  methods: {
    getCanvas: function getCanvas() {var _this = this;
    ...
    touch: function touch(e) {var _this2 = this;
      var m = e.touches;
      var detectPixelColor = collisionCtx.getImageData(m[0].x, m[0].y, 1, 1); //获取鼠标点击的那块区域的相关属性
      var pc = detectPixelColor.data; //鼠标点击的那块区域的rgb值如rgb(0,0,0,0.1)
      // console.log('pc',pc)
    ...
    animate: function animate(timestamp) {
      ...
      var deltatime = timestamp - this.lastTime; //0-
      ...
      [].concat(_toConsumableArray(particles), _toConsumableArray(ravens), _toConsumableArray(explosions)).forEach(function (object) {
        object.update(deltatime);
      });
      [].concat(_toConsumableArray(particles), _toConsumableArray(ravens), _toConsumableArray(explosions)).forEach(function (object) {object.draw();});
      ravens = ravens.filter(function (object) {return !object.markForDeletion;});
      explosions = explosions.filter(function (object) {return !object.markForDeletion;});
      particles = particles.filter(function (object) {return !object.markForDeletion;});
      if (!gameOver) {
    ...
    drawScore: function drawScore() {//绘制左上的游戏分数面版
      canvasCtx.fillStyle = 'black';
      canvasCtx.fillText('Score:' + this.score, 50, 75); //阴影效果
      canvasCtx.fillStyle = 'white';
      canvasCtx.fillText('Score:' + this.score, 50, 76);
    },

    drawGameOver: function drawGameOver() {//绘制游戏结束面板
      canvasCtx.textAlign = 'center';
      canvasCtx.fillStyle = 'black';
      canvasCtx.fillText('Game Over your score is :' + this.score, canvas.width / 2, canvas.height / 2);
      canvasCtx.fillStyle = 'white';
      canvasCtx.fillText('Game Over your score is :' + this.score, canvas.width / 2, canvas.height / 2 + 2);
    },
...
/* 18 */
/*!*******************************************************************************************************************!*\
  !*** C:/Users/Admin/Desktop/黑马优购/final-version-crow-game/pages/index/index.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
